...
filepath = 'C:\\Users\\swarn\\Tomato leave disease detection\\model.h5'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread("C:\\Users\\swarn\\Tomato leave disease detection\\test\\Tomato___healthy (6).JPG")
